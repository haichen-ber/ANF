...
class PointNetSetAbstraction(nn.Module):  # 首先先通过sample_and_group的操作形成局部的group，然后对局部的group中的每一个点做MLP操作，最后进行局部的最大池化，得到局部的全局特征。
    ...
    def forward(self, xyz, points):
        ...
        Input:
            ...
            points: input points data, [B, N, C]   (CSDN:[B,D,N])
        Return:

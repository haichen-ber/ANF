...
BEST_WEIGHTS = {
    ...
    'scanobject': {
        1024: {
            'pointnet': 'logs/scanobject/pointnet/BEST_model150_acc_0.6537.pth',
            'pointnet2': 'logs/scanobject/pointnet2/BEST_model180_acc_0.7547.pth',
            'pointconv': 'logs/scanobject/pointconv/BEST_model180_acc_0.7922.pth',
            'dgcnn': 'logs/scanobject/dgcnn/BEST_model180_acc_0.7679.pth',
            'pct': 'logs/scanobject/pct/BEST_model180_acc_0.7908.pth'
        },
    },
